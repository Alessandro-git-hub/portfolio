<template>
  <footer class="border-t border-slate-200 px-6 py-8">
    <div class="mx-auto max-w-5xl flex flex-col items-center justify-between gap-4 sm:flex-row">
      <p class="text-sm text-slate-400">
        &copy; {{ new Date().getFullYear() }} Alessandro Poggio. Built with Vue.js &amp; Tailwind CSS.
      </p>
      <div class="flex gap-5">
        ...
        <a
          href="https://www.linkedin.com/in/alessandro-poggio/"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="LinkedIn"
          class="text-slate-400 transition-colors hover:text-slate-600"
